...
### [1.1. A small history of Java](#a-small-history-of-java)
...
### [1.2. Hello world Java program](#hello-world-java-program)
...
### [1.3. Java virtual machine](#java-virtual-machine)
...
### [1.4. Java Runtime Environment vs. Java Development Kit](#java-runtime-environment-vs-java-development-kit)
...
### [1.5. Development Process with Java](#development-process-with-java)
...
### [1.6. Garbage collector](#garbage-collector)
...
### [2.1. Check installation](#check-installation)
...
### [2.2. Install Java on Ubuntu](#install-java-on-ubuntu)
...
### [2.3. Install Java on MS Windows](#install-java-on-ms-windows)
...
### [2.4. Installation problems and other operating systems](#installation-problems-and-other-operating-systems)
...
### [2.5. Validate installation](#validate-installation)
...
### [3.1. Write source code](#write-source-code)
...
### [3.2. Compile and run your Java program](#compile-and-run-your-java-program)
...
### [3.3. Using the classpath](#using-the-classpath)
...
### [4.4. Inheritance](#javadef_inheritance)
...
### [4.5. Object as superclass](#javadef_objectsuperclass)
...
### [4.6. Exception handling in Java](#exception-handling-in-java)
...
### [4.7. Checked Exceptions](#checked-exceptions)
...
### [4.8. Runtime Exceptions](#runtime-exceptions)
...
### [5.1. What is an interface in Java?](#javadef_interface)
...
### [5.2. Abstract, default and static methods in Interfaces](#javadef_interfacemethods)
...
### [5.3. Implementing Interfaces](#javadef_interfaceimplementing)
...
### [5.4. Evolving interfaces with default methods](#javadef_interfaceevolving)
...
### [5.5. Multiple inheritance of methods](#javadef_interface_multiple)
...
### [5.6. Functional interfaces](#javadef_functionalinterfaces)

All interfaces that have only one method are called *functional interfaces*. Functional interfaces have the advantage that they can be used together with *lambda expressions*. See [What are lambdas?](#lambdas_definition) to learn more about lambdas, e.g., the type of lambdas is a functional interface.
...
### [6.1. Annotations in Java](#annotations_definition)
...
### [6.2. Override methods and the @Override annotation](#javadef)
...
### [6.3. The @Deprecated annotations](#annotation_deprecated)
...
### [6.4. Type annotations](#annotation_typeannotations)
...
### [7.2. Instance variable](#javadef_instancevariable)
...
### [7.3. Local variable](#javadef_localvariable)
...
### [7.5. Main method](#javadef_mainmethod)
...
### [7.6. Constructor](#javadef_constructor)
...
### [8.1. Access modifiers](#javadef_accessmodifier)
...
### [8.2. Other modifiers](#javadefinitions_othermodifiers)
...
### [9.1. Usage of import statements](#javaimports_definition)
...
### [9.2. Static imports](#javaimport_staticimports)
...
### [10.1. Class methods and class variables](#javadef_classmethod)
...
### [10.2. Abstract class and methods](#javadef_abstractclass)
...
### [11.1. Working with classes](#cheatsheets_class)
...
### [11.2. Working with local variable](#cheatsheets_localvariable)
...
### [13.1. Create a Person class and instantiate it](#exercises_starter1)
...
### [13.2. Use constructor](#exercises_starter2)
...
### [13.3. Define getter and setter methods](#exercises_starter3)
...
### [13.4. Create an Address object](#exercises_starter4)
...
### [14.1. Create a Person class and instantiate it](#exercises_starter1_solution)

The following is the expected result after [Create a Person class and instantiate it](#exercises_starter1).
...
### [14.2. Use constructor](#exercises_starter2_solution)

The following is the expected result after [Use constructor](#exercises_starter2).
...
### [14.3. Define getter and setter methods](#exercises_starter3solution)

The following is the expected result after [Define getter and setter methods](#exercises_starter3).
...
### [14.4. Solution - Create an Address object](#exercises_starter4solution)

The following is the expected result after [Create an Address object](#exercises_starter4).
...
### [15.1. Conversion to String](#Conversion_tostring)
...
### [15.2. Conversion from String to Number](#conversion_tonumber)
...
### [15.3. Double to int](#conversion_toint)

int i = (int) double;

### [15.4. SQL Date conversions](#conversion_sqldate)
...
### [16.1. if-then and if-then-else](#javalang_if)
...
### [16.2. Switch](#languageconstructsss1as2b)
...
### [16.3. Boolean Operations](#languageconstructs_comparison)
...
### [17.1. The for loop](#javalang_for)
...
### [17.2. The while loop](#javalang_while)
...
### [17.3. The do while loop](#javalang_dowhile)
...
### [18.1. Arrays in Java](#arrays_definition)
...
### [18.2. Enhanced for loop for Arrays and Collections](#arrays_forloop)
...
### [19.1. Strings in Java](#javastringdefinition)
...
### [19.2. String pool in Java](#javastringpool)
...
### [19.3. Compare Strings in Java](#javastringcompare)
...
### [19.4. Working with Strings](#javastringhandling)
...
### [20.1. What are lambdas?](#lambdas_definition)
...
### [20.2. Purpose of lambda expressions](#lambdas_purpose)
...
### [20.3. Using method references](#lambdas_methodreferences)
...
### [20.4. Difference between a lambda expression and a closure](#lambdas_closures)
...
### [21.3. Reduction operations with streams and lambdas](#lambdas_reduction)
...
### [21.4. Example for filtering and mapping the content of a list](#lambdas_examples)
...
### [21.5. Streams and lambda examples](#streams_examples)
